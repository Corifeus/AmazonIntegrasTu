 ...
 */
class Otro extends \PIGBundle\Entity\Otro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PIGBundle\\Entity\\Otro' . "\0" . 'id', '' . "\0" . 'PIGBundle\\Entity\\Otro' . "\0" . 'id_servicio', '' . "\0" . 'PIGBundle\\Entity\\Otro' . "\0" . 'especificaciones'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Otro $proxy) {
