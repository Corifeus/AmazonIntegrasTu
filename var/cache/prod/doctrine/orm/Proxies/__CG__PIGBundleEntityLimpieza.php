 ...
 */
class Limpieza extends \PIGBundle\Entity\Limpieza implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PIGBundle\\Entity\\Limpieza' . "\0" . 'id', '' . "\0" . 'PIGBundle\\Entity\\Limpieza' . "\0" . 'id_servicio', '' . "\0" . 'PIGBundle\\Entity\\Limpieza' . "\0" . 'productos', '' . "\0" . 'PIGBundle\\Entity\\Limpieza' . "\0" . 'especificaciones'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Limpieza $proxy) {
